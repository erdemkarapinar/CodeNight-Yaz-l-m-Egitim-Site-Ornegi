        ...
        <header class="sticky-top" style="background-color: yellow; box-shadow: 5px 5px 5px #999;">
            ...
            <div class="container">
                <div class="row">      
                    ...
                    @foreach($a as $kategory => $category)
                        @php
                            // Sabit resim ve açıklama dizilerinden uygun olanları seç
                            $image = $images[$kategory % count($images)];
                            $description = $descriptions[$kategory % count($descriptions)];
                        @endphp
                        <div class="col-md-6">
                            <div class="card" style="margin: 5px; box-shadow: 2px -1px 5px 2px #999">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            {{ $descriptions[$kategory % count($descriptions)] }}
                                        </p>
