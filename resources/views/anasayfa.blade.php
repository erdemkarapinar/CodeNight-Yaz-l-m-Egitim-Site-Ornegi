...
<html>
  ...
  <meta charset="utf-8">
	...
	<body>
        ...
        <section class="md-4" style="margin: 2px">
            <div class="container">
                <div class="row">
                    @foreach($a as $index => $category)
                        @php
                            // Sabit resim ve açıklama dizilerinden uygun olanları seç
                            $image = $images[$index % count($images)];
                            $description = $descriptions[$index % count($descriptions)];
                        @endphp
                        <div class="col-md-6">
                            <div class="card" style="margin: 5px; box-shadow: 2px -1px 5px 2px #999">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $category->category }}</h5>
                                        <img class="card-image" src="{{ $image }}" alt="{{ $category->category }}" style="box-shadow: 5px 2px 5px 2px #999; width: 300px; height: 300px;">
                                        <p class="card-text">
                                            {{ $descriptions[$index % count($descriptions)] }}
                                        </p>
                                        <a href="" class="btn btn-primary">Kategoriye Göz At</a>
                                    </div>
                            </div> 
                        </div>
            ...
            <section class="md-4">
                <div class="container-fluid"  style="background-color: #2F4F4F ;box-shadow: 5px -5px 8px 1px">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 style="color: white;">Hakkımızda</h3>
                        </div>
                        <div class="col-md-4">
                            <strong style="color: white;">CodeNight Grup olarak siz öğrencilerimiz için bilişim dünyasına adım atmayı sağlayan ve sitemizin
                             içerisinde yer alan eğitimlerle öğrencilerimize aradıkları eğitimi videolarla, testler ile öğretmeyi ssağlayan bir eğitim platformuyuz.</strong>
                        </div>
                        <div class="col-md-4">
                            <img src="https://cdn.dribbble.com/userupload/8579202/file/original-f41faa8ac879146ccc929975ad15630b.png?resize=752x" style="width: 300px;">
                        </div>
                    </div>
                </div>
            </section>       
        ...
        <footer style="background-color: yellow; box-shadow: 5px -5px 8px 2px; margin: 2px;">
